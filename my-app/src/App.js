...
function App() {
  ...
  const Add = (e) => {
    ...
    let currentQ1 = document.querySelector('#questionnaire01').value
    ...
    let sum = parseInt(currentA00) + parseInt(currentA01) + parseInt(currentA02) + parseInt(currentA03) + parseInt(currentA04) + parseInt(currentA05) + parseInt(currentA99) + parseInt(currentCommits) + parseInt(currentE01) + parseInt(currentE02) + parseInt(currentMidterm) + parseInt(currentFinal) + parseInt(currentQ1);
